...
export const TwoColumnTemplate: React.FC<TwoColumnTemplateProps> = async ({ slug, data }) => {
    return (
        <div className="flex flex-col gap-0 w-full">
            <div className="flex flex-col gap-0 items-center sm:items-start w-full">
                {renderBlocks(data.slots.top, slug)}
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center sm:items-start w-full">
                <div className="flex flex-col gap-0 items-center sm:items-start w-full">
